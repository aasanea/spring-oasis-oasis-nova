...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DDv1eovi.mjs");
...
var manifest = {
	"239dabb3fe58ad0735940ae5181847300627b110c4f7f6cf324bf4f462457a02": {
		functionName: "runDeskAgent_createServerFn_handler",
		importer: () => import("./run-agent-iYhR-y0i.mjs")
	},
	"3a36a7f06740ca00f7075dc52f13f4b187a4eee4114a91a3ae0c487bb6f8a5a8": {
		functionName: "loadMarketTape_createServerFn_handler",
		importer: () => import("./market-BSNf5wVd.mjs")
	},
	"9baa11ffe301913bee5889991398ca9cf9bc060991e2e51e0fa87d7b61f4ae83": {
		functionName: "loadMarketWire_createServerFn_handler",
		importer: () => import("./market-BSNf5wVd.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dcy2Oume.mjs").then((n) => n.t),
